...
const Workspace = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col bg-zinc-950 text-zinc-300 overflow-hidden">
      {/* Top Section: Workspace Main layout */}
      <div className={`flex flex-1 overflow-hidden ${isResizingSidebar || isResizingEditor ? "select-none" : ""}`}>
      ...
      {/* Bottom Section: Time Travel Timeline */}
      {executionMode === "draft" && (
        <TimelineSlider
          snapshots={snapshots}
          ...
          onFinalizeBaseline={finalizeBaseline}
        />
      )}
    </div>
  );
